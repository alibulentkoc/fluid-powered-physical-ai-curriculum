...
*Figure: digital twin workflow — see full diagram above.* (the cylinder ODE block)
...
```
Re-explain this lesson from Module 04 (Fluid Mechanics) of the Fluid-Powered Physical AI curriculum: "Cylinder dynamics: the force balance". Teach it through the running machine — the Smart Agricultural Workcell — using physical intuition first, then the math. Keep hydraulic terminology precise.
```

**Practice prompt** — generate more exercises

```
Give me 5 practice problems for this lesson ("Cylinder dynamics: the force balance", Module 04 — Fluid Mechanics) on the Smart Agricultural Workcell, with full worked solutions. Mix conceptual and numerical.
```

**Explore prompt** — connect it to the real world

```
Show me how this lesson's concept ("Cylinder dynamics: the force balance") appears in real agricultural, construction, or industrial hydraulic machines, with concrete examples and typical numbers.
```
...
```
I just studied this lesson ("Cylinder dynamics: the force balance", Module 04 — Fluid Mechanics) from the Fluid-Powered Physical AI curriculum.
